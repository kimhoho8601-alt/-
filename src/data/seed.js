export const members = [
  { id: 1, name: '김철수', role: '관리자', avatar: '🐻' },
  { id: 2, name: '이영희', role: '팀원', avatar: '🐰' },
  { id: 3, name: '박민수', role: '팀원', avatar: '🐼' },
  { id: 4, name: '최지은', role: '팀원', avatar: '🐱' },
  { id: 5, name: '김서연', role: '팀원', avatar: '🦊' },
  { id: 6, name: '정우진', role: '팀원', avatar: '🐶' },
];
