...
export default function Layout({ page, setPage, children }) {
  return <div className="app-shell">
    ...
    <main className="main-area">
      <header className="topbar"><div><h1>{items.find(i=>i[0]===page)?.[1]}</h1><p>팀의 업무와 회의 정보를 한 곳에서 관리합니다.</p></div><div className="user-chip"><img className="avatar" src="./avatars/bear.svg" alt="김철수 캐릭터"/><div><strong>김철수</strong><small>관리자</small></div></div></header>
      {children}
    </main>
  </div>
}
